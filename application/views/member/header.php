...
<head>
  ...
  <title>Membership | Bandung Giri Gahana Golf Golf and Resort</title>
  <!-- BOOTSTRAP STYLES-->
  ...
  <div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?=base_url()?>admin">Membership</a>
      </div>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          ...
          <li>
            <a class="active-menu"  href="<?=base_url()?>member"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
          </li>
            <li>
                <a class=""  href="<?=base_url()?>member/eventcalendar"><i class="fa fa-calendar fa-3x"></i> Event Calendar</a>
            </li>
          <li>
            <a class=""  href="<?=base_url()?>member/news"><i class="glyphicon glyphicon-list-alt fa-3x"></i> News</a>
          </li>
<!--          <li>-->
