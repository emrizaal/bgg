...
<script id="facebook-jssdk" src="<?=base_url()?>assets/js/all.js"></script>
<script src="<?=base_url()?>assets/js/jquery.js"></script>
<script type="text/javascript" src="<?=base_url()?>assets/js/jquery.easing.1.3.js"></script>
<script src="<?=base_url()?>assets/js/modernizr.custom.js"></script>
<!--<script type="text/javascript" src="assets/js/pgu6lcb.js"></script>-->
<script type="text/javascript" src="<?=base_url()?>assets/js/vticker.js"></script>
...
<link href="<?=base_url()?>assets/css/sau_general.css" rel="stylesheet" type="text/css">
<link href="<?=base_url()?>assets/css/sau_response.css" rel="stylesheet" type="text/css">

<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/css/component_menu.css">
...
<div id="mb-header"><a href="<?=base_url()?>home"></a></div>
<div id="mb-menu">
    <div class="slicknav_menu">
        <ul id="mobilemenu" class="slicknav_nav slicknav_hidden" style="display: none;" aria-hidden="true" role="menu">
            ...
            <li>CONTACTS
                <ul>
                    <li><a href="<?=base_url()?>contacts/management" class="navlink" role="menuitem" tabindex="-1">Management &amp; Committees</a></li>
                    <li><a href="<?=base_url()?>contacts/location" class="navlink" role="menuitem" tabindex="-1">Location</a></li>
