	...
	<div class="row-section">
		...
		<div class="block-48-L">
			...
			<div class="block-100"><div class="pad-20">
				...
				</select> <input name="send" id="send" type="submit" value="GO">
			</form>

			<h2 class="tcen">Malaysia</h2>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="recipro">
				<tbody><tr>
					...
					<tr>
						...
						<div class="block-break" style="text-align:center">
							<div class="block-80-C" style="border-bottom:solid 1px #E1D2B6; padding-bottom:10px; margin-bottom:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tbody><tr>
									<td colspan="2" align="left" valign="top"><span class="t13"> * All play is subject to the Club Rules and By-Laws.</span></td>
								</tr>
								<tr>
									<td width="60%" align="left" valign="top" style="padding-right:10px;" class="border-R">
										<span class="t13"><strong>Members are required to make bookings through Saujana before visiting and to bring the following.</strong></span>
										<ul class="list-noborder t13">
											<li>SGCC Membership Card.</li>
											<li>Introduction Card.</li>
											<li>USGA Handicap Card.</li>
										</ul></td>
										<td width="40%" align="left" valign="top" style="padding-left:10px;"><span class="t13"><strong>Legend</strong></span>
											<ul class="list-noborder t13">
												<li>50% - 50% of member guest rate</li>
												<li>MGR - Member guest rate</li>
												<li>FOC - No green fee</li>
											</ul></td>
										</tr>
									</tbody></table>
								</div>
