...
<div id="page-wrapper" >
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h2 align="center">Edit Resort Facilities</h2> 
                <hr>
            </div>
        </div>
        <div class="row">
        <div class="col-md-12">
            <form action="<?=base_url()?>admin/updateResortFacilities" method="POST" role="form">
            <input type="hidden" name="id" value="<?=$data['id_resort_facilities']?>">
